...
public class MovieWriter implements MessageBodyWriter<Movie> {
    ...
    @Override
    public void writeTo(Movie t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream out) throws IOException, WebApplicationException {
